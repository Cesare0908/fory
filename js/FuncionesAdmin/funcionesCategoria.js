document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.querySelector("#tablaCategorias")) {
        ...
        const grid = new gridjs.Grid({
            ...
            resizable: true,
            server: {
                url: "http://localhost/fory-final/controladores/controladorCat.php?ope1=ListaCategorias",
        ...
        document.querySelector("#tablaCategorias").addEventListener("click", (event) => {
            ...
            if (ele.classList.contains("editar")) {
                ...
                xhr.open('POST', 'http://localhost/fory-final/controladores/controladorCat.php');
        ...
        document.querySelector("#btnGuardarCategoria").addEventListener("click", function (event) {
            ...
            let xhr = new XMLHttpRequest();
            xhr.open('POST', "http://localhost/fory-final/controladores/controladorCat.php", true);
            xhr.onload = function () {
                let response = JSON.parse(xhr.responseText);
