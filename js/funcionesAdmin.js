document.addEventListener('DOMContentLoaded', () => {
  const modulos = {
      dashboard: 'Dashboard.php', // Módulo agregado
      pedidos: 'GestionPedidos.php',
      usuarios: 'GestionUsuarios.php',
      repartidores: 'GestionRepartidores.php',
      productos: 'GestionProductos.php',
      categorias: 'GestionCategorias.php',
  ...
  window.checkNotifications = function() {
      fetch('../Consultas/check_notifications.php')
