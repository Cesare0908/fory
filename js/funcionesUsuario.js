document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.querySelector("#tablaUsuarios")) {
        ...
        const grid = new gridjs.Grid({
            ...
            resizable: true,
            server: {
                url: "../controladores/controladorUsu.php?ope1=ListaUsuarios",
        ...
        document.querySelector("#tablaUsuarios").addEventListener("click", (event) => {
            ...
            if (ele?.classList.contains("ver-detalles")) {
                ...
                xhr.open('POST', '../controladores/controladorUsu.php');
                    ...
                    if (xhr.status === 200 && xhr.response && xhr.response.success) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                deleteXhr.open('POST', '../controladores/controladorUsu.php');
        ...
        document.querySelector("#btnGuardarUsuario").addEventListener("click", function (event) {
            ...
            let xhr = new XMLHttpRequest();
            xhr.open('POST', "../controladores/controladorUsu.php", true);
            xhr.onload = function () {
...
function cargarRoles() {
    let xhr = new XMLHttpRequest();
    xhr.open('GET', '../controladores/controladorUsu.php?ope1=ListaRoles');
    xhr.onload = function () {
        if (xhr.status === 200) {
