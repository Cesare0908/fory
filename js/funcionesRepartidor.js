document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.querySelector("#tablaRepartidores")) {
        ...
        const grid = new gridjs.Grid({
            ...
            resizable: true,
            server: {
                url: "../controladores/controladorRep.php?ope1=ListaRepartidores",
        ...
        document.querySelector("#tablaRepartidores").addEventListener("click", (event) => {
            ...
            if (ele?.classList.contains("ver-detalles")) {
                ...
                xhr.open('POST', '../controladores/controladorRep.php');
        ...
        document.querySelector("#btnGuardarRepartidor").addEventListener("click", function (event) {
            ...
            let xhr = new XMLHttpRequest();
            xhr.open('POST', "../controladores/controladorRep.php", true);
            xhr.onload = function () {
                let response = JSON.parse(xhr.responseText);
...
function cargarUsuarios() {
    let xhr = new XMLHttpRequest();
    xhr.open('GET', '../controladores/controladorRep.php?ope1=ListaUsuarios');
    xhr.onload = function () {
        if (xhr.status === 200) {
