document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.querySelector("#tablaPedidos")) {
        ...
        const grid = new gridjs.Grid({
            ...
            resizable: true,
            server: {
                url: `../controladores/controladorPedidos.php?ope1=ListaPedidos&estado=${filtroEstado}`,
                then: (data) => {
        ...
        document.querySelector("#exportarPDF").addEventListener("click", () => {
            window.location.href = `../consultas/exportarPedidosPdf.php?formato=pdf&estado=${filtroEstado}`;
        });

        // Exportar Excel
        document.querySelector("#exportarExcel").addEventListener("click", () => {
            window.location.href = `../consultas/exportarPedidosPdf.php?formato=excel&estado=${filtroEstado}`;
        });
        ...
        document.querySelector("#tablaPedidos").addEventListener("click", (event) => {
            ...
            if (ele?.classList.contains("ver-detalles")) {
                ...
                xhr.open('POST', '../controladores/controladorPedidos.php');
        ...
        document.querySelector("#btnGuardarPedido").addEventListener("click", (event) => {
            ...
            let xhr = new XMLHttpRequest();
            xhr.open('POST', "../controladores/controladorPedidos.php", true);
            xhr.onload = function () {
                let response;
                try {
        ...
        document.querySelector("#id_usuario").addEventListener("change", (e) => {
            ...
            if (idUsuario) {
                let xhr = new XMLHttpRequest();
                xhr.open('GET', `../controladores/controladorPedidos.php?ope1=ListaDirecciones&id_usuario=${idUsuario}`);
                xhr.onload = function () {
                    if (xhr.status === 200) {
...
function cargarSelects() {
    ...
    xhrClientes.open('GET', '../controladores/controladorPedidos.php?ope1=ListaClientes');
    ...
    xhrEst.open('GET', '../controladores/controladorPedidos.php?ope1=ListaEstablecimientos');
    ...
    xhrMet.open('GET', '../controladores/controladorPedidos.php?ope1=ListaMetodosPago');
    ...
    xhrRep.open('GET', '../controladores/controladorPedidos.php?ope1=ListaRepartidores');
    ...
    xhrProd.open('GET', '../controladores/controladorPedidos.php?ope1=ListaProductos');
