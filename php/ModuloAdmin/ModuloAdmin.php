...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/fory-final/css/DISENOSADMIN/admin.css?v=4">
</head>
...
<body>
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 sidebar" id="sidebar">
                <div class="d-flex flex-column">
                    ...
                    <button class="btn-menu" data-modulo="repartidores" onclick="cargarContenido('repartidores')"><i class="fas fa-motorcycle me-2"></i>Repartidores</button>
    ...
    <script src="http://localhost/fory-final/js/FuncionesAdmin/funcionesAdmin.js?v=8888"></script>
</body>
